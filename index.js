...
const SimpleHeaterLightAccessory = require('./lib/SimpleHeaterLightAccessory');
...
const PLUGIN_NAME = 'homebridge-tuya-PD';
const PLATFORM_NAME = 'TuyaLanPD';
...
const CLASS_DEF = {
    ...
    simpleheaterlight: SimpleHeaterLightAccessory,
